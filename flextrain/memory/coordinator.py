...
class FlexTrainInterLayerCoordinator:
    ...
    def _init_coordinator(self, tensor: Tensor):
        ...
        # Finalize the alpha split plan of the optimizer coordinator.
        get_opt_coordinator().finalize_alpha_split()
...
class FlexTrainOptCoordinator:
    ...
    def initialize(
        ...
        self._forward_opt_splits = _get_split_numels(
            self._forward_numel * self._opt_state_per_element,
            opts_cpu_nvme_ratio, num_levels=2
        )
        self._backward_opt_splits = _get_split_numels(
        ...
        # CPU optimizer base.
        self._cpu_opt_fwd_base = _allocate_memory_chunks(
        ...
        self._cpu_opt_bwd_base = _allocate_memory_chunks(
