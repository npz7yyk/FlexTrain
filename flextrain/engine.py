...
class LLMTensorGroupInfo:
    """
    LLM Tensor Group Info is a class that contains information about
    target LLM parameters in the manner of contiguous tensor groups.
    """
...
_LLM_TENSOR_GROUP_INFO = LLMTensorGroupInfo()
